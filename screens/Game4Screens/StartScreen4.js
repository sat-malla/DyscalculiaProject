...
const StartScreen4 = ({ navigation }) => {
  ...
  return (
    ...
    >
      <Text style={{ fontSize: 35, fontWeight: "bold", marginTop: 60, color: colors.text }}>Welcome to Game 4!</Text>
      <Text style={{ fontSize: 19, marginTop: 40, color: colors.text, textAlign: "center" }}>Let's talk about the Commutative Property!</Text>
